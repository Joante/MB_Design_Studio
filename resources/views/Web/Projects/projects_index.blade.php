...
@section('content')
    <!-- Header Banner -->
    <section class="banner-header banner-img bg-img bg-fixed pb-0" data-background="{{ Helper::viteAsset('images/1920x1128.jpg') }}" data-overlay-darkgray="5"></section>
    <!-- Projects -->
                    ...
                    <div class="col-md-6 animate-box" data-animate-effect="fadeInUp">
                        <div class="item">
                            <div class="position-re o-hidden">
                                ...
                                @else
                                    <img src="{{ Helper::viteAsset('images/1920x1128-1.jpg') }}" alt=""> 
                                @endif
                            </div>
                            <div class="con">
