...
@section('content')
    <section class="banner-header2 banner-img valign bg-img bg-fixed" data-overlay-darkgray="5" data-background="{{ Helper::viteAsset('img/1920x1128.jpg') }}"></section>

    <section class="pb-90">
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <img src="{{ Helper::viteAsset('img/404-image.png') }}" class="mb-30" alt="404">
