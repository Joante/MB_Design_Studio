...
@section('title', 'Agregar Coleccion de Arte')
...
<section>
    <div class="col-12 justify-content-center">
      <div class="card">
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('paint_colection_store') }}" id="form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <textarea id="description-column" class="form-control @error('description') is-invalid @enderror" placeholder="Descripcion" name="description" required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
